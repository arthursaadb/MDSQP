...
const val initialPopulation = 100 // Tamanho da população inicial
...
fun main() {
    ...
    val initialMatrix = generateInitial(initialPopulation, queens, bits)

    getDominatedPositions(initialMatrix, tabuleiro)
}
...
fun getDominatedPositions(initialMatrix: Array<Array<String>>, tabuleiro: Array<IntArray>) {
    ...
    initialMatrix.forEachIndexed { indexMatrix, strings ->
        ...
        for (indexQueen in 0 until queens) {
            ...
            fitness.add(calculateFitnessFunction(dominateSpace.size))
